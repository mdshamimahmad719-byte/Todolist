  ...
  const Dashboard = () => (
    ...
    >
      ...
      <div className="grid grid-cols-2 gap-4">
        <GlassCard 
          className="col-span-2 h-48 flex flex-col justify-between bg-gradient-to-br from-blue-600/20 to-transparent cursor-pointer"
        ...
        {CATEGORIES.map((cat) => (
          <div key={cat.name}>
            <GlassCard 
              className="h-40 flex flex-col justify-between cursor-pointer hover:bg-white/10 transition-colors"
              onClick={() => {
                setSelectedCategory(cat.name);
                setView('tasks');
              }}
            >
              <div className={`w-10 h-10 ${cat.color} rounded-xl flex items-center justify-center shadow-lg`}>
                <cat.icon size={20} />
              </div>
              <div>
    ...
    return (
      ...
      >
        <header className="flex items-center gap-4">
          <button onClick={() => setView('dashboard')} className="p-2 glass rounded-xl">
            <X size={20} />
          </button>
      ...
      >
        ...
        <div className="flex gap-6">
          <button 
            ...
            className="w-20 h-20 rounded-full bg-white text-black flex items-center justify-center shadow-xl shadow-white/10 hover:scale-105 transition-transform"
          >
          ...
          <button 
            ...
            className="w-20 h-20 rounded-full glass flex items-center justify-center hover:scale-105 transition-transform"
          >
            <RotateCcw size={28} />
          </button>
        </div>
    ...
    <div className="min-h-screen font-sans selection:bg-blue-500/30">
      ...
      <main className="max-w-md mx-auto px-6 py-12 min-h-screen relative">
        <AnimatePresence mode="wait">
          ...
          {view === 'timer' && <TimerView key="timer" />}
        </AnimatePresence>
